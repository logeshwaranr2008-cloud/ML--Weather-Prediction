...
## Algorithm
1. Load and preprocess the environmental sensor dataset.
2. Split the dataset into training and testing data.
3. Train the Random Forest model using the training dataset.
4. Predict temperature, PM2.5 level, and energy values, then evaluate the model accuracy.
...
```
## Output:
<img width="512" height="415" alt="image" src="https://github.com/user-attachments/assets/6624e2b0-7324-495c-b46e-0113ac517b4d" />


## Result:
Thus, the Random Forest Algorithm was implemented successfully to predict daily temperature, PM2.5 pollution level, and energy consumption using environmental sensor data.
